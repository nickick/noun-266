...
const Video = () => {
  return (
    <section id='video'>
      <div className='text-[2rem] px-6 md:px-0 md:w-4/5 flex flex-row flex-nowrap mx-auto'>
      ...
      <div className='flex items-center justify-center py-12 relative pb-[56.25%] pt-10 h-0 max-w-screen-xl mx-auto'>
        <iframe
