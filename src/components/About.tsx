...
const About = () => {
  return (
    <div className='md:w-4/5 md:mx-auto border mx-6 rounded-[40px] p-6 pb-16 pt-48 md:pt-24 md:pl-24 md:pb-16 text-base leading-8 relative mt-[16rem] md:mt-[20rem] max-w-screen-xl' id="bio">
      <div className='md:w-[25.5rem] space-y-8 relative z-30'>
        <h3 className='text-5xl'>
          Noun 266
        </h3>
        <p className='text-base leading-8'>
          Born &apos;266&apos; on <a href='https://nouns.wtf/noun/266' className='underline' target='_blank' rel="noreferrer" >April 7th, 2022</a> to the Nouns family, Noun 266 was destined for music greatness. With his signature Chart Head and clean aesthetics, he found his calling collaborating with Richerd Intern in late 2022. Having performed on national television as a world-renowned DJ, Noun 266 is ready to take the world by storm with his debut single, &quot;We Can Have Fun&quot;.
        </p>
      </div>
